...
#[derive(Debug)]
pub struct SenpaiBotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SenpaiBotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SenpaiBot processing");
    
    let mut processor = SenpaiBotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SenpaiBotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SenpaiBotProcessor::new(false);
